<?php
    ...
    $title = "Welcome |Kaya Store"; //title for header
                ...
                <div class="row">
                            ...
                            <div class="analytics-content">
                                ...
                                <h2><span class="counter">
                                    <?php
                                        echo $parent;
                                    ?>
                                </span> <span class="tuition-fees">Mother and Child</span></h2>
                                <span class="text-success">5% of Target</span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:5%;"> <span class="sr-only">5% Complete</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="analytics-content">
                                ...
                                <h2><span class="counter">
                                    <?php
                                        echo $staff;
                                    ?>
                                </span> <span class="tuition-fees">Full Capacity</span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>Development Gap</h5>
                                <h2><span class="counter">
                                <?php
                                        echo $dev_gap;
                                    ?>
                                </span> 
                                    <span class="tuition-fees">Number of Children</span></h2>
                                <span class="text-info">60% of target achieved</span>
                                <div class="progress m-b-0">
                            ...
                            <div class="analytics-content">
                                ...
                                <h2><span class="counter">
                                    <?php
                                        echo $donors;
                                    ?>
                                </span> <span class="tuition-fees">Number</span></h2>
                                <span class="text-inverse">50% of Target</span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-inverse" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:50%;"> <span class="sr-only">230% Complete</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
