...
?>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>We are team of talented students making learning easier for our fellow colleagues</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <ul>
              ...
              <li><i class="bi bi-check-circle"></i> Incorporate the sense of communal love in fellow students through the collective sharing of resources and reviews of courses</li>
            </ul>
            <p>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <p>
               We believe in Ashesi's learning goals and that is why we wanted to build this for our beautiful community. All your lecturers have endorsed this idea so you can trust us that we will deliver.
              </p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Our courses ensure that a student is inquisitive and confident, has breadth of knowledge, and has attained a high level of mastery in his/her chosen field.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Our courses ensure that a student is able to apply critical thinking and quantitative reasoning to approach complex problems.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
